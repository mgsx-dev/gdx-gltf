...
class GLTFBinaryExporter {
  ...
  public Array<GLTFBuffer> flushAllToFiles(String baseName) {
    Array<GLTFBuffer> out = new Array<>();
    int count = 0;
  ...
  public static void savePNG(FileHandle file, Pixmap pixmap) {
    if (Gdx.app.getType() == ApplicationType.WebGL) {
      ...
      try {
        ...
        Method pixmapIOWritePNG = ClassReflection.getMethod(pixmapIO, "writePNG", FileHandle.class, Pixmap.class);
        pixmapIOWritePNG.invoke(null, file, pixmap);
