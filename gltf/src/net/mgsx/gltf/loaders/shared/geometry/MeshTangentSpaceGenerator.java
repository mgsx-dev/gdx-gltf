...
public class MeshTangentSpaceGenerator {
  ...
  public static void computeTangentSpace(float[] vertices, short[] indices, VertexAttributes attributesGroup,
                                         boolean computeNormals, boolean computeTangents, VertexAttribute normalMapUVs) {
    if (computeNormals) {
      computeNormals(vertices, indices, attributesGroup);
    }
    if (computeTangents) {
      computeTangents(vertices, indices, attributesGroup, normalMapUVs);
    }
  }
  ...
  private MeshTangentSpaceGenerator() {
