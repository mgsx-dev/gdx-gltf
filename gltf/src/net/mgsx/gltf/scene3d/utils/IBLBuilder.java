...
/** Quick procedural IBL environment generation. Should be disposed when no longer used.
 * 
 * IBL generated by this class are accurate, some fast approximation are performed to provide a quick way to setup an IBL environment. For accurate IBL, see:
 * https://learnopengl.com/PBR/IBL/Specular-IBL and https://learnopengl.com/PBR/IBL/Diffuse-irradiance and related tools to generate them from HDRIs.
 * 
 * @author mgsx */
public class IBLBuilder implements Disposable {
	...
	private IBLBuilder() {
		...
		sunShader = new ShaderProgram(Gdx.files.classpath("net/mgsx/gltf/shaders/ibl-sun.vs.glsl"), Gdx.files.classpath("net/mgsx/gltf/shaders/ibl-sun.fs.glsl"));
	...
	/** Creates an radiance map, to be used with {@link net.mgsx.gltf.scene3d.attributes.PBRCubemapAttribute#SpecularEnv} generated cubemap contains mipmaps in order to perform
	 * roughness in PBR shading
	 * 
