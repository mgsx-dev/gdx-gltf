...
public class ImportGLTFTest extends Game {
  ...
  public static void main(String[] args) {
    if (args.length < 1) {
      throw new GdxRuntimeException("program argument required");
    }
    if (args.length > 1) {
      throw new GdxRuntimeException("too many program arguments");
    }
  ...
  public void create() {
    ...
    if (!file.exists()) {
      throw new GdxRuntimeException("file not found: " + path);
    }
